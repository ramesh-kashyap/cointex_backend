...
class Profile extends Controller
{
    ...
    public function computing_power($date)
    {
        $PowerRecords = Income::where('user_id', Auth::user()->id)
                              ->where('remarks', 'Task Income')
                              ->whereDate('created_at', $date) // Filters by the specified date
                              ->orderBy('created_at', 'desc') // Orders records by date in descending order
                              ->get();
    ...
    {
        $this->data['page'] = 'user.profile.feedback';
        return $this->dashboard_layout();
    }
...
public function BankDetail()
    ...
    // public function computing_income()
    // {
 
    //     $incomeRecords = Income::where('user_id', Auth::id())
    //                            ->where('remark', 'Task Income')
    //                            ->orderBy('created_at', 'desc')
    //                            ->get();
    
    //     return view('your_view_name', compact('incomeRecords'));
    // }
