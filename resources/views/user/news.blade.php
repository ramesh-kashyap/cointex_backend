...
<head>
    ...
    <link href="{{asset('')}}css/chunk-651f43fb.bb1ebe18.css" rel="prefetch">
    ...
    <meta name="viewport"
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-651f43fb.bb1ebe18.css">
    <style type="text/css">
        x-vue-echarts {
            display: flex;
    ...
    <script charset="utf-8" src="/static/js/chunk-2ec80ff3.6280bc33.js"></script>
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
</head>
...
<body>
    ...
    height: 25px;">
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container" id="articleContainer">
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-6b868a30="" class="tw-min-h-full tw-bg-white tw-text-black">
                        <img data-v-6b868a30="" class="tw-w-full tw-h-auto"
                             id="articleImage" 
                            lazy="loaded">
                        <div data-v-6b868a30="" class="tw-p-16px">
                            <div data-v-6b868a30="" class="tw-mb-16px tw-flex tw-items-center"><img data-v-6b868a30=""
                                    alt="" class="tw-w-48px tw-h-48px tw-rounded-full"
                                    data-src="http://seokore-all.s3.ap-southeast-1.amazonaws.com/upload/20240821/e5761afad54dbcb3221d39c6665affe4.png"
                                    src="http://seokore-all.s3.ap-southeast-1.amazonaws.com/upload/20240821/e5761afad54dbcb3221d39c6665affe4.png"
                                    lazy="loaded">
                                <div data-v-6b868a30="" class="tw-ml-12px">
                                    <div data-v-6b868a30="" class="tw-text-16px" id="articleTitle"></div>
                                    <div data-v-6b868a30="" class="tw-text-12px tw-text-secondary"> 2024-08-20 08:18:27
                                    </div>
                                </div>
                            </div>
                            <div data-v-6b868a30="" class="doc" style="font-size: 0.32rem;">
                                <p><strong>SEOKORE Business License and MSB Financial License Search</strong><br>
                                    <br>
                                    MSB financial license inquiry website: https://www.fincen.gov/msb-stateselector</p>

                                <p>1. Company name: SEOKORE TECHNOLOGY INC<br>
                                    2. License code search: 31000278981493</p>

                                <p><br>
                                    Business license inquiry website:http://ecorp.dos.ny.gov/</p>
    ...
    <script>
    // Retrieve the article data from sessionStorage
    const articleData = JSON.parse(sessionStorage.getItem('selectedArticle'));

    // Check if the data exists
    if (articleData) {
        // Populate the page with the article data
        document.getElementById('articleTitle').innerText = articleData.title;
        document.getElementById('articleImage').src = articleData.urlToImage;
        document.getElementById('articleSource').innerText = articleData.source.name;
        document.getElementById('articleDescription').innerText = articleData.description;
    } else {
        // Handle the case where no data is available
        document.getElementById('articleContainer').innerText = 'No article selected.';
    }
</script>
    <!---->
</body>
