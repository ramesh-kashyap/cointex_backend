            ...
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><svg data-v-3f1a7394="" aria-hidden="true" class="svg-icon"
                    ...
                    <div data-v-6b868a30="" class="page-team-container tw-min-h-full tw-p-16px">
                        ...
                        <div data-v-6b868a30="" class="page-team-header tw-text-white tw-relative">
                            ...
                            <div data-v-6b868a30="" class="tw-absolute tw-top-0 tw-right-16px tw-w-72px tw-h-72px">
                                    <svg data-v-3f1a7394="" aria-hidden="true" class="svg-icon" data-v-6b868a30="" style="width: 1.694rem; height: 1.694rem; font-size: 1.694rem;">
                                        <use data-v-3f1a7394="" xlink:href="#svg-icon-usdt-large"></use>
                                    </svg></div>
                                <div data-v-6b868a30="" class="tw-text-12px tw-opacity-80" style="color:#020503"> Cumulative Income </div>
                                <div data-v-6b868a30="" class="tw-text-28px tw-font-bold" style="color:#020503"> {{number_format($totalLevelIncome,2)}} USDT </div>
                                <div data-v-6b868a30=""
                                    class="tw-flex tw-justify-between tw-items-center tw-px-28px tw-py-16px tw-bg-white tw-bg-opacity-90 tw-rounded-8px" style="background-color: #313131">
                                    <div data-v-6b868a30="" class="tw-flex-1 tw-text-center">
                                        <div data-v-6b868a30="" class="tw-text-primary tw-text-18px tw-font-bold" style="color:#fff"> 0
                                        </div>
                                        <div data-v-6b868a30="" class="tw-text-12px tw-text-secondary tw-mt-8px" style="color:#fff">
                                            Cumulative Deposit </div>
                                    </div>
                                    <div data-v-6b868a30="" class="tw-flex-1 tw-text-center">
                                        <div data-v-6b868a30="" class="tw-text-dark tw-text-18px tw-font-bold"style="color:#fff"> 0 </div>
                                        <div data-v-6b868a30="" class="tw-text-12px tw-text-secondary tw-mt-8px" style="color:#fff">
                            ...
                            <div data-v-6b868a30=""
                                class="tw-p-12px tw-flex tw-justify-between tw-items-center tw-text-dark"><span
                                    data-v-6b868a30="" class="tw-text-14px" style="color:#fff">View Team List</span><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow" style="color:#fff" onClick="window.location.href='{{route('user.list')}}'">
                                    <!----></i></div>
                        </div>
                        <div data-v-6b868a30="" class="tw-mb-16px tw-grid tw-grid-cols-3 tw-gap-12px">
                            <div data-v-6b868a30="" class="tw-flex-1 tw-p-12px tw-bg-white tw-rounded-10px statisic">
                                ...
                                <div data-v-6b868a30="" class="tw-mt-6px tw-text-secondary tw-text-12px"> Number of
                                    Users </div>
                                <div data-v-6b868a30="" class="tw-mt-12px tw-text-18px tw-font-bold"> {{$totalTeam}}/{{$ActivetotalTeam}}</div>
                            </div>
                            <div data-v-6b868a30="" class="tw-flex-1 tw-p-12px tw-bg-white tw-rounded-10px statisic">
                                <svg data-v-3f1a7394="" aria-hidden="true" class="svg-icon" data-v-6b868a30=""
                                    style="width: 0.6588rem; height: 0.6588rem; font-size: 0.6588rem;">
                                ...
                                <div data-v-6b868a30="" class="tw-mt-12px tw-text-18px tw-text-success tw-font-bold"> 0
                                </div>
                            </div>
                            <div data-v-6b868a30="" class="tw-flex-1 tw-p-12px tw-bg-white tw-rounded-10px statisic">
                                <svg data-v-3f1a7394="" aria-hidden="true" class="svg-icon" data-v-6b868a30=""
                        ...
                        <div data-v-6b868a30="" class="tw-p-16px tw-bg-white tw-rounded-10px">
                            <div data-v-6b868a30="" class="tw-mb-12px tw-pb-12px van-hairline--bottom">
                                ...
                                <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center">
                                    ...
                                    <dl data-v-6b868a30="" class="tw-text-center">
                                        <dt data-v-6b868a30="" class="tw-mb-8px">{{number_format($gen_team1Recharge,1)}}</dt>
                                        <dd data-v-6b868a30="" class="tw-text-12px tw-text-secondary"> Commission Rate
                                        </dd>
                                    </dl>
                                    <dl data-v-6b868a30="" class="tw-text-right">
                                        <dt data-v-6b868a30="" class="tw-mb-8px">  {{number_format($gen_team1Earning,2)}} </dt>
                            ...
                            <div data-v-6b868a30="" class="tw-mb-12px tw-pb-12px van-hairline--bottom">
                                ...
                                <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center">
                                    ...
                                    <dl data-v-6b868a30="" class="tw-text-center">
                                        <dt data-v-6b868a30="" class="tw-mb-8px">{{number_format($gen_team2Recharge,1)}}</dt>
                                        <dd data-v-6b868a30="" class="tw-text-12px tw-text-secondary"> Commission Rate
                                        </dd>
                                    </dl>
                                    <dl data-v-6b868a30="" class="tw-text-right">
                                        <dt data-v-6b868a30="" class="tw-mb-8px"> {{number_format($gen_team2Earning,2)}} </dt>
                                        <dd data-v-6b868a30="" class="tw-text-12px tw-text-secondary"> Cumulative Income
                                        </dd>
                                    </dl>
                                </div>
                            ...
                            <div data-v-6b868a30="" class="">
                                ...
                                <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center">
                                    ...
                                    <dl data-v-6b868a30="" class="tw-text-center">
                                        <dt data-v-6b868a30="" class="tw-mb-8px">{{number_format($gen_team3Recharge,1)}}</dt>
                                        <dd data-v-6b868a30="" class="tw-text-12px tw-text-secondary"> Commission Rate
                                        </dd>
                                    </dl>
                                    <dl data-v-6b868a30="" class="tw-text-right">
                                        <dt data-v-6b868a30="" class="tw-mb-8px"> {{number_format($gen_team3Earning,2)}} </dt>
                                        <dd data-v-6b868a30="" class="tw-text-12px tw-text-secondary"> Cumulative Income
                                        </dd>
                                    </dl>
                                </div>
                        ...
                        <div data-v-6b868a30="" class="tw-mt-16px tw-p-16px tw-bg-white tw-rounded-10px">
                            ...
                            <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center">
                                ...
                                <dl data-v-6b868a30="" class="tw-text-center">
                                    <dt data-v-6b868a30="" class="tw-mb-8px"> {{number_format($gen_team1Withdraw,2)}} </dt>
                        ...
                        <div data-v-6b868a30="" class="tw-mt-16px tw-p-16px tw-bg-white tw-rounded-10px">
                            ...
                            <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center">
                                ...
                                <dl data-v-6b868a30="" class="tw-text-center">
                                    <dt data-v-6b868a30="" class="tw-mb-8px"> {{number_format($gen_team2Withdraw,2)}} </dt>
                                    <dd data-v-6b868a30="" class="tw-text-12px tw-text-secondary"> Cumulative Withdrawal
                                    </dd>
                                </dl>
                                <dl data-v-6b868a30="" class="tw-text-right">
                        ...
                        <div data-v-6b868a30="" class="tw-mt-16px tw-p-16px tw-bg-white tw-rounded-10px">
                            ...
                            <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center">
                                ...
                                <dl data-v-6b868a30="" class="tw-text-center">
                                    <dt data-v-6b868a30="" class="tw-mb-8px"> {{number_format($gen_team3Withdraw,2)}} </dt>
                                    <dd data-v-6b868a30="" class="tw-text-12px tw-text-secondary"> Cumulative Withdrawal
                                    </dd>
                                </dl>
                                <dl data-v-6b868a30="" class="tw-text-right">
