...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-0fd8d233.1744e2a9.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
</head>
...
<body class="">
        ...
        <div data-v-6b868a30="" class="page">
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <form action="{{route('user.submitFeedback')}}" method="post">
                    {{ csrf_field() }}
                    <div data-v-6b868a30="" class="tw-min-h-full tw-p-16px tw-flex tw-flex-col">
                        <div data-v-6b868a30="" class="tw-mb-24px tw-flex-1">
                            <div data-v-6b868a30=""
                                class="tw-mb-16px tw-px-14px tw-py-20px tw-bg-white tw-rounded-10px">
                                <div data-v-6b868a30="" class="tw-text-14px"> Feedback type </div>
                                <div role="radiogroup" class="van-radio-group" data-v-6b868a30="">
                                    <ul>
                                        <li
                                            class="tw-mt-16px tw-p-12px tw-h-50px tw-flex tw-justify-between tw-items-center tw-bg-primary tw-bg-opacity-5 tw-rounded-10px">
                                            <label class="tw-flex tw-justify-between tw-items-center tw-w-full">
                                                <div class="tw-font-bold tw-text-14px">Software function problem</div>

                                                <div class="van-radio">
                                                    <div class="van-radio__icon van-radio__icon--round">
                                                        <input type="radio" name="type" value="software_problem"
                                                            class="tw-hidden" />
                                                    </div>
                                                </div>
                                            </label>
                                        ...
                                        <li
                                            class="tw-mt-16px tw-p-12px tw-h-50px tw-flex tw-justify-between tw-items-center tw-bg-primary tw-bg-opacity-5 tw-rounded-10px">
                                            <label class="tw-flex tw-justify-between tw-items-center tw-w-full">
                                                <div class="tw-font-bold tw-text-14px">Complaints and suggestions</div>
                                                <div class="van-radio">
                                                    <div class="van-radio__icon van-radio__icon--round">
                                                        <input type="radio" name="type"
                                                            value="complaints_suggestions" class="tw-hidden" />
                                                    </div>
                                                </div>
                                            </label>
                                        </li>
                                        <li
                                            class="tw-mt-16px tw-p-12px tw-h-50px tw-flex tw-justify-between tw-items-center tw-bg-primary tw-bg-opacity-5 tw-rounded-10px">
                                            <label class="tw-flex tw-justify-between tw-items-center tw-w-full">
                                                <div class="tw-font-bold tw-text-14px">Bug report</div>
                                                <div class="van-radio">
                                                    <div class="van-radio__icon van-radio__icon--round">
                                                        <input type="radio" name="type" value="bug_report"
                                                            class="tw-hidden" />
                                                    </div>
                                                </div>
                                            </label>
                                        ...
                                        <li
                                            class="tw-mt-16px tw-p-12px tw-h-50px tw-flex tw-justify-between tw-items-center tw-bg-primary tw-bg-opacity-5 tw-rounded-10px">
                                            <label class="tw-flex tw-justify-between tw-items-center tw-w-full">
                                                <div class="tw-font-bold tw-text-14px">Other</div>
                                                <div class="van-radio">
                                                    <div class="van-radio__icon van-radio__icon--round">
                            ...
                            <div data-v-6b868a30="" class="tw-px-14px tw-py-20px tw-bg-white tw-rounded-10px">
                                <div data-v-6b868a30="" class="tw-mb-16px tw-text-14px"> Your feedback </div>
                                <div class="!tw-bg-light tw-rounded-10px van-cell van-field" data-v-6b868a30="">
                                    <div class="van-cell__value van-cell__value--alone van-field__value">
                                        <div class="van-field__body"><textarea rows="5" name="feedback"
                                                placeholder="Please enter your comments" class="van-field__control"
                                                style="height: 136px;"></textarea></div>
                                        <div class="van-field__word-limit"><span
                                                class="van-field__word-num">0</span>/500</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button data-v-6b868a30="" class="van-button van-button--primary van-button--normal" type="submit"><div data-v-6b868a30="" class="van-button__content"><span data-v-6b868a30="" class="van-button__text"> Confirm </span></div></button>
                    </div>
                    </form>
                </div>
            </div>
    ...
    <script src="/static/js/chunk-vendors.c7ccfd16.js"></script>
    <script src="/static/js/app.fbea1ebc.js"></script>
