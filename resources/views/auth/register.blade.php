...
<script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/intlTelInput.min.js"></script>
    ...
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <link rel="stylesheet" type="text/css" href="css/chunk-681c0118.11557bbb.css">
    <script charset="utf-8" src="/static/js/chunk-681c0118.c5252bb7.js"></script>
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <link rel="stylesheet" type="text/css" href="css/chunk-75f71fd8.db1cfce5.css">
    <script charset="utf-8" src="/static/js/chunk-75f71fd8.3e0757bf.js"></script>
    <script charset="utf-8" src="/static/js/chunk-2d22d3f8.66bf80bf.js"></script>
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
</head>
                    ...
                    <div data-v-6b868a30="" class="page-auth-container tw-h-full tw-p-20px">
                        <div data-v-6b868a30=""
                            class="page-auth-header tw-relative tw-z-10 tw-mb-20px tw-flex tw-items-center"><img
                                data-v-6b868a30="" src="img/logo.41d208eb.svg" alt=""
                        ...
                        <div data-v-6b868a30="" class="page-auth-content tw-relative tw-z-10">
                            <div data-v-6b868a30="" class="page-auth-form tw-pb-24px">
                                <div data-v-6b868a30=""
                                    ...
                                    <div data-v-6b868a30="" class="page-auth-form-title"> Registration </div><a
                                        href="/downApp" class="tw-mt-16px tw-flex tw-items-center"
                                        data-v-6b868a30=""><svg data-v-3f1a7394="" aria-hidden="true" class="svg-icon"
                                ...
                                <div data-v-6b868a30=""
                                    ...
                                    <div class="van-cell van-field !tw-px-0 cell-after-full" data-v-6b868a30="">
                                        <div class="van-cell__value van-cell__value--alone van-field__value">
                                            <div class="van-field__body"><input type="text"  name="email" id="emailId"
                                    ...
                                    <div class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                                        <div class="van-cell__value van-cell__value--alone van-field__value">
                                            <div class="van-field__body"><input type="tel" inputmode="numeric" name="code" id="code"
                                                    placeholder="Please enter the verification code"
                                                    class="van-field__control">
                                                <div class="van-field__right-icon">
                                                    <span
                                                        class="code-btn !tw-border-none tw-w-8 van-button van-button--primary van-button--mini van-button--plain">
                                    ...
                                    <div class="van-cell van-field !tw-px-0 cell-after-full" data-v-6b868a30="">
                                        <div class="van-cell__value van-cell__value--alone van-field__value">
                                            <div class="van-field__body"><input type="text" name="sponsor" value="{{$sponsor}}" id="sponsor"
                                    ...
                                    <div class="van-cell van-field !tw-px-0 cell-after-full" data-v-6b868a30="">
                                        <div class="van-cell__value van-cell__value--alone van-field__value">
                                            <div class="van-field__body"><input type="password" name="password" id="passwordInput"
                                    ...
                                    <div class="van-cell van-field !tw-px-0 cell-after-full" data-v-6b868a30="">
                                        <div class="van-cell__value van-cell__value--alone van-field__value">
                                            <div class="van-field__body"><input type="password" name="password_confirmation" id="passwordInput2"
                                                    autocomplete="new-password"
                                                    placeholder="Please enter a password (6-20 alphanumeric characters)"
                                                    class="van-field__control">
                                                <div class="van-field__right-icon"><i
...
<script>
    ...
    // Set only the country code in the hidden field on submit
    document.querySelector("form").addEventListener("submit", function() {
        countryCodeField.value = phoneInput.getSelectedCountryData().dialCode;
    });
</script>
    ...
    $('#check').click(function(){
          ...
          if($(this).hasClass('van-icon-closed-eye')){
