...
"></div>
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-6b868a30=""
                        class="tw-h-full tw-px-16px tw-relative tw-flex tw-flex-col tw-overflow-y-hidden" style="overflow-y:scroll">
                        <div data-v-6b868a30="" class="page-invite-top">
                            ...
                            <div data-v-6b868a30=""
                                class="tw-mx-auto tw-p-10px tw-w-150px tw-h-150px tw-flex tw-justify-center tw-items-center tw-bg-white tw-rounded-10px">
                                <div value="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ asset('') }}register?ref={{ Auth::user()->username }}&format=png" level="H"
                                    background="#fff" foreground="#000" class="custom-qrcode" data-v-6b868a30=""><img
                                        src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ asset('') }}register?ref={{ Auth::user()->username }}&format=png" height="240" width="240" style="width: 240px; height: 145px;"></div>
                            </div>
                        </div>
                        <div data-v-6b868a30="" class="page-invite-bottom">
                            <div data-v-6b868a30=""
                                class="tw-mb-12px tw-p-16px tw-bg-white tw-bg-opacity-60 tw-rounded-10px">
                                ...
                                <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center">
                                    <div data-v-6b868a30="" class="tw-pr-12px tw-flex-1 tw-break-all tw-leading-none" id="clipboardright2">
                                    {{ asset('') }}register?ref={{ Auth::user()->username }} </div>
                                    <div data-v-6b868a30=""><svg data-v-3f1a7394="" aria-hidden="true" class="svg-icon"
                                            data-v-6b868a30=""
                                            style="color: rgb(10, 113, 247); width: 0.6118rem; height: 0.6118rem; font-size: 0.6118rem;">
                                            <use data-v-3f1a7394="" xlink:href="#svg-icon-copy-line" class="copy" id="copy-button2"></use>
                                        </svg></div>
                                </div>
                            </div>
                            <div data-v-6b868a30=""
                                ...
                                <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center">
                                    <div data-v-6b868a30="" class="tw-flex-1 tw-break-words tw-leading-none" id="clipboardright"> {{Auth::user()->username}}
                                    </div>
                                    <div data-v-6b868a30=""><svg data-v-3f1a7394="" aria-hidden="true" class="svg-icon"
                                            data-v-6b868a30=""
                                            style="color: rgb(10, 113, 247); width: 0.6118rem; height: 0.6118rem; font-size: 0.6118rem;">
                                            <use data-v-3f1a7394="" xlink:href="#svg-icon-copy-line"class="copy " id="copy-button"></use>
                                        </svg></div>
                                </div>
                            </div>
                        </div>
