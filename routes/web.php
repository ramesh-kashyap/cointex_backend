...
Route::get('/news', [App\Http\Controllers\UserPanel\Dashboard::class, 'stop_trade'])->name('user.news');
...
Route::get('/computing-power/{date}', [App\Http\Controllers\UserPanel\Profile::class, 'computing_power'])->name('user.computing-power');
...
Route::get('/feedback',[App\Http\Controllers\UserPanel\Profile::class, 'feedback'])->name('user.feedback');
Route::post('/Feedback',[App\Http\Controllers\UserPanel\Profile::class, 'submitFeedback'])->name('user.submitFeedback');
...
Route::get('/grid', [App\Http\Controllers\UserPanel\Invest::class, 'grid'])->name('user.grid');
Route::get('/video', [App\Http\Controllers\UserPanel\Invest::class, 'video'])->name('user.video');
...
Route::post('/generate_roi', [App\Http\Controllers\UserPanel\Invest::class, 'generate_roi'])->name('user.generate_roi');
...
//pln
Route::get('/package', [App\Http\Controllers\UserPanel\Profile::class, 'package'])->name('user.package');
//pln
// withdraw
...
Route::get('/Market', [App\Http\Controllers\UserPanel\Invest::class, 'nodepower'])->name('user.Market');
