...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-02c8c6ba.f02a30c2.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
</head>
            ...
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <div class="tw-w-44px tw-h-full tw-flex tw-items-center">
                        <img src="/img/left.png" onClick="window.location.href='{{route('user.Mine')}}'" style="
    height: 25px;">
                        <!---->
                    </div>
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Personal information</span></div>
...
@endif
                        <div data-v-6b868a30="" class="tw-flex-1">
                            <div data-v-6b868a30="" class="tw-mt-32px tw-mb-20px tw-flex tw-justify-center">
                                <div data-v-6b868a30=""
                                    ...
                                    <svg
                                            ...
                                            <use data-v-3f1a7394="" xlink:href="#svg-icon-edit">                                            
                                            </use>
                                        </svg></div>
                                </div>
                            </div>
                            <div class="tw-mb-16px tw-rounded-10px van-cell van-cell--large van-field"
                                data-v-6b868a30="">
                                <div class="van-cell__title van-field__label"><span>Nickname</span></div>
                                <div class="van-cell__value van-field__value">
                                    <div class="van-field__body"><input name="nickname" type="text" value="{{Auth::user()->nickname}}"
                                            ...
                                            <input type="radio" name="gender" value="male" id="male">
                                                <div role="radio" tabindex="0" aria-checked="true"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="tw-flex tw-items-center tw-text-14px"><span
                                                                class="tw-pr-4px">Male</span>
                                                                <svg data-v-3f1a7394=""  onClick="document.getElementById('male').click();"
                                                                aria-hidden="true" class="svg-icon"
                                                                style="color: rgb(23, 114, 248); width: 0.4706rem; height: 0.4706rem; font-size: 0.4706rem;">
                                                                
                                                            </svg></div>
                                                    </div>
                                                </div>
                                                <div role="radio" tabindex="-1" aria-checked="false"
                                                    class="van-radio van-radio--horizontal">
                                                    <input type="radio" name="gender" value="female" id="female" >
                                                    <div class="van-radio__icon van-radio__icon--round">
                                                        <div class="tw-flex tw-items-center tw-text-14px"><span
                                                                class="tw-pr-4px">Female</span><svg data-v-3f1a7394="" onClick="document.getElementById('female').click();"
                                                                aria-hidden="true" class="svg-icon"
                                                                style="color: rgb(234, 238, 245); width: 0.4706rem; height: 0.4706rem; font-size: 0.4706rem;">
                            ...
                            <div class="tw-mb-16px tw-rounded-10px van-cell van-cell--large van-field"
                                data-v-6b868a30="">
                                <div class="van-cell__title van-field__label"><span>Mobile phone number</span></div>
                                <div class="van-cell__value van-field__value">
