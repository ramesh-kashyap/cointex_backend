...
<head>
    ...
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-50b10c92.241dffcb.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    ...
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-29126459.fe5ce88a.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    ...
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-f6532530.0eb12746.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
</head>
        ...
        <div data-v-6b868a30="" data-v-7c19a79c="" class="page">
            <div data-v-6b868a30="" class="headers">
                <div data-v-7c19a79c="" class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center"
                    ...
                    <div class="tw-w-44px tw-h-full tw-flex tw-items-center"><img src="/img/left.png" onClick="window.location.href='{{route('user.Mine')}}'" style="
    height: 25px;">
                        <!---->
                    </div>
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Modify Mail</span></div>
            ...
            {{ csrf_field() }}
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-7c19a79c="" data-v-6b868a30="" class="tw-h-full tw-p-16px tw-flex tw-flex-col">
                        <div data-v-7c19a79c="" data-v-6b868a30="" class="tw-flex-1 tw-mb-32px">                            
                            <div data-v-7c19a79c="" class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input type="email" name="email" readonly=""  value="{{Auth::user()->email}}" class="van-field__control">
                                        
                                    </div>
                                </div>
                            </div>
                            <div data-v-7c19a79c="" data-v-6b868a30=""  class="tw-mt-16px psd-title tw-mb-10px tw-text-14px"> Varification Code </div>
                            <div data-v-7c19a79c="" class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input type="" name="first_code"
                                    placeholder="Enter verification code" maxlength="" class="van-field__control">
                                        <div class="van-field__right-icon"><i data-v-7c19a79c=""
                                                class="first-code-send">
                                                Get Code</i></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div data-v-7c19a79c="" class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input ttype="email" name="newEmail" value="" id="emailId" placeholder="Enter your email"
                                            class="van-field__control">
                                            <div class="van-field__right-icon"><i data-v-7c19a79c=""
                                                class="sencond-code-send">
                                                Get Code</i></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div data-v-7c19a79c="" class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input type="" name="second_code"
                        ...
                        </div><button data-v-7c19a79c="" data-v-6b868a30="" type="submit"
...
<script>
    ...
    <div class="van-toast van-toast--middle van-toast--text" style="z-index: 2009; display: none;">
        <div class="van-toast__text">Google verification code cannot be empty</div>
    </div>
</body>
