...
<head>
    ...
    <script charset="utf-8" src="/static/js/chunk-5ac3d6ec.c95b3c0e.js"></script>
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-926160c6.52e9758a.css">
    <script charset="utf-8" src="/static/js/chunk-926160c6.ba295f6f.js"></script>
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-7136a154.e2d1f0d3.css">
    <script charset="utf-8" src="/static/js/chunk-7136a154.54ea98ae.js"></script>
    <script charset="utf-8" src="/static/js/chunk-2d21f097.e7facfb5.js"></script>
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-4e5f1a7a.de8b1aed.css">
    <script charset="utf-8" src="/static/js/chunk-4e5f1a7a.0836d7d7.js"></script>
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <script charset="utf-8" src="/static/js/chunk-2d212f56.01328b3a.js"></script>
    ...
    <script charset="utf-8" src="/static/js/chunk-991698c0.c9e26ba2.js"></script>
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-4c3afbae.12cc21e8.css">
    <script charset="utf-8" src="/static/js/chunk-4c3afbae.7d6c3fda.js"></script>
    ...
    <script charset="utf-8" src="/static/js/chunk-54637b65.0fa57117.js"></script>
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
</head>
        ...
        <div data-v-6b868a30="" class="page">
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <div class="tw-w-44px tw-h-full tw-flex tw-items-center"><img src="/img/left.png" onClick="window.location.href='{{route('user.wallet')}}'" style="
    height: 25px;">
                        <!---->
                    </div>
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Withdrawal</span></div>
                    ...
                    <div data-v-6b868a30="" class="page-withdraw tw-min-h-full tw-p-16px">
                        ...
                        <div data-v-386f4b33="" class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                            <div class="van-cell__value van-cell__value--alone van-field__value">
                                <div class="van-field__body"><select id="paymentMode" name="paymentMode"
                        ...
                        <div class="tw-rounded-10px van-cell van-field" data-v-6b868a30="">
                            <div class="van-cell__value van-cell__value--alone van-field__value">
                                <div class="van-field__body"><input value="{{ Auth::user()->usdtTrc20 }}"
                                    placeholder="Please enter the withdrawal address" name="walletAddress"
                                    id="walletAddress" class="van-field__control">
                        ...
                        <div class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                            <div class="van-cell__value van-cell__value--alone van-field__value">
                                ...
                                type="text"
                                        ...
                                        id="withdrawalAmount" class="van-field__control">
                        ...
                        <div data-v-6b868a30="" class="tw-mt-18px tw-mb-10px tw-text-14px"> Transection Password </div>
                        <div class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                            <div class="van-cell__value van-cell__value--alone van-field__value">
                                <div class="van-field__body"><input type="text" inputmode="decimal"
                                type="password"
                                        placeholder="Please enter the transaction password"
                                        name="transaction_password"  class="van-field__control">
                                    <div class="van-field__right-icon">
                                        <div class="tw-text-primary"> <i class="van-icon van-icon-closed-eye tw-text-secondary">
                                        <!----></i> </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div data-v-6b868a30=""
                            ...
                            <span data-v-6b868a30="" class="tw-text-secondary">Withdrawable Balance</span><span
                        ...
                        <div data-v-6b868a30="" class="tw-mb-12px tw-flex tw-justify-between tw-items-center"><span
                                data-v-6b868a30="" class="tw-text-secondary"> Arived Quantity </span><span
                                data-v-6b868a30="" id="arrivedQuantity">0 USDT</span></div>
                                <div data-v-6b868a30="" class="tw-mb-12px tw-flex tw-justify-between tw-items-center"><span
                                data-v-6b868a30="" class="tw-text-secondary"  id="withdrawalFee"> 0 USDT </span><span
                        ...
                        <div data-v-6b868a30=""
                            class="tw-mt-18px tw-mb-24px tw-p-14px tw-text-14px tw-bg-white tw-rounded-10px">
