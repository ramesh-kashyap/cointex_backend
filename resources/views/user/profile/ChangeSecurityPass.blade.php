...
<body>
    ...
    height: 25px;">
                    ...
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Create Transaction Password</span></div>
                        ...
                        <div data-v-7c19a79c="" data-v-6b868a30="" class="tw-flex-1 tw-mb-32px">                            
                            <div data-v-7c19a79c="" class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input value="{{ Auth::user()->email }}" id="emailId" name="emailId" class="van-field__control">
                            ...
                            <div data-v-7c19a79c="" class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input name="code"
                                    id="code" placeholder="Enter verification code" class="van-field__control">
                            ...
                            <div data-v-7c19a79c="" class="van-cell van-field tw-rounded-10px" data-v-6b868a30="">
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input type="password"
                                        placeholder="Please enter the new password" name="password"
