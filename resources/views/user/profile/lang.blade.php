        ...
        <div data-v-6b868a30="" class="page">
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <div class="tw-w-44px tw-h-full tw-flex tw-items-center"><svg data-v-3f1a7394="" aria-hidden="true" onClick="window.history.back()"
                            class="svg-icon"
                    ...
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color:#fff;"><span>Switch Language</span></div>
                    <div class="tw-h-full tw-min-w-44px tw-flex tw-justify-end tw-items-center tw-gap-12px">
                        ...
                        ><img src="/img/bell.png" style="height: 25px;">
                        </div>
                        <!---->
                        <!---->
                    </div>
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-6b868a30="" class="tw-min-h-full tw-p-16px">
                        <div data-v-6b868a30="" class="tw-p-14px tw-bg-white tw-rounded-10px">
                            <div role="radiogroup" class="van-radio-group" data-v-6b868a30="">
                                <ul>
                                    <li
                                        class="tw-p-12px tw-h-48px tw-flex tw-justify-between tw-items-center tw-rounded-10px">
                                        <div class="tw-flex tw-items-center tw-font-bold tw-text-14px">
                                            <!----><span>Deutsch </span></div>
                                        <div role="radio" tabindex="-1" aria-checked="false" class="van-radio"
                                            style="display: none;">
                                            <div class="van-radio__icon van-radio__icon--round"><i
                                    ...
                                    <li
                                        class="tw-p-12px tw-h-48px tw-flex tw-justify-between tw-items-center tw-rounded-10px tw-bg-body">
                                        <div class="tw-flex tw-items-center tw-font-bold tw-text-14px">
