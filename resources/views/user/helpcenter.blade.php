...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-ea0143b0.c5452a2e.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-5ac3d6ec.c8f2d705.css">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-4e5f1a7a.de8b1aed.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
 
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-4c3afbae.12cc21e8.css">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-54637b65.30970f55.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
        ...
        <div data-v-6b868a30="" class="page">
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <div class="tw-w-44px tw-h-full tw-flex tw-items-center"><img src="/img/left.png" onClick="window.location.href='{{ route('user.dashboard') }}'" style="
    height: 25px;
">
                        <!---->
                    </div>
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Help Center</span></div>
                    <div class="tw-h-full tw-min-w-44px tw-flex tw-justify-end tw-items-center tw-gap-12px">
                        <!---->
                        <div><img src="/img/bell.png" style="height: 25px;"></div>
                        <!---->
                        <!---->
                    </div>
                </div>
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-6b868a30="" class="tw-min-h-full tw-p-16px">
                        <ul data-v-6b868a30=""
                            class="tw-mb-16px tw-h-40px tw-p-4px tw-flex tw-justify-between tw-items-center tw-bg-white tw-rounded-10px">
                            <li data-v-6b868a30="" onclick=onhelp()
                                class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-secondary tw-rounded-8px tw-text-primary tw-bg-primary tw-bg-opacity-10">
                                FAQ </li>
                            <li data-v-6b868a30="" onclick=onhelp2()
                                class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-secondary tw-rounded-8px">
                                Security Related </li>
                        </ul>
                        <div data-v-6b868a30="" class="tw-py-6px tw-bg-white tw-rounded-10px" id="help1" style="display:none">
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">SEOKORE
                                        multi-dimensional profit model </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">How to upgrade
                                        SEOKORE account level </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">Benefits of
                                        increasing the level of SEOKORE's strategy</span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">Advantages of
                                        SEOKORE grid strategy trading </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">SEOKORE Grid
                                        Strategy Operation Guide</span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">Why SEOKORE
                                        uses USDT for settlement </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">BenefiSeokore
                                        of creating a SEOKORE community</span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">SEOKORE
                                        Community Benefit Calculation Guide </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">How to become
                                        an effective user of SEOKORE</span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">How SEOKORE
                                        earns income </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">Other
                                        advantages of SEOKORE</span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <!---->
                        </div>
                        <div data-v-6b868a30="" class="tw-py-6px tw-bg-white tw-rounded-10px" id="help2" style="display:none">
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">SEOKORE
                                        Withdrawal Instructions </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">Why adopt the
                                        72-hour fund review mechanism?</span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">How to Choose a
                                        Trustworthy Cryptocurrency Trading Platform</span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">Guide to
                                        Improving SEOKORE Account Security </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">SEOKORE Fund
                                        Withdrawal Guide </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30="" role="button" tabindex="0" class="van-cell van-cell--clickable">
                                <div data-v-6b868a30="" class="van-cell__title"><span data-v-6b868a30="">SEOKORE
                                        Recharge Guide </span></div><i data-v-6b868a30=""
                                    class="van-icon van-icon-arrow van-cell__right-icon">
                                    <!----></i>
                            </div>
                            <!---->
    ...
    <script>
        var heep = document.getElementById('help1');
        var heep1 = document.getElementById('help2');
       function onhelp(){
     
         heep.style.display ="block";
         heep1.style.display ="none";
       }
      function onhelp2(){
        
        heep.style.display ="none";
         heep1.style.display ="block";
      }
    </script>
