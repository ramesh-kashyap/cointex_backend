...
<body class="">
    ...
    height: 25px;">
                    ...
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Upgrade Level</span></div>
...
"></div>
                ...
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-6b868a30="" class="tw-min-h-full tw-p-16px">
                        <ul data-v-6b868a30=""
                            ...
                            <li class="tw-text-16px tw-text-secondary active" id="SK0" data-vip="0"> SK0 </li>
                                <li class="tw-text-16px tw-text-secondary" id="SK1" data-vip="1"> SK1 </li>
                                <li class="tw-text-16px tw-text-secondary" id="SK2" data-vip="2"> SK2 </li>
                                <li class="tw-text-16px tw-text-secondary" id="SK3" data-vip="3"> SK3 </li>
                                <li class="tw-text-16px tw-text-secondary" id="SK4" data-vip="4"> SK4 </li>
                                <li class="tw-text-16px tw-text-secondary" id="SK5" data-vip="5"> SK5 </li>
                                <li class="tw-text-16px tw-text-secondary" id="SK6" data-vip="6"> SK6 </li>
                                </ul>
                                ...
                                <div class="van-swipe-item" style="width: 389px;">
                                    <div class="tw-my-24px tw-flex tw-flex-col tw-justify-center tw-items-center">
                                        <div class="tw-my-16px tw-w-160px tw-h-160px van-image"><img
                                                ...
                                                <div class="page-upgrade-vip-status active" id="unlocked"
                                                    style="display: none;">
                                                    This level has been unlocked
                                                </div>
                                                <div class="page-upgrade-vip-status active" id="locked"
                                                    style="display: none;">
                                                    This level has been locked
                                                </div>
                                                </div>
                                </div>
                                <div class="van-swipe-item" style="width: 389px;">
                                    <div class="tw-my-24px tw-flex tw-flex-col tw-justify-center tw-items-center">
                                        <div class="tw-my-16px tw-w-160px tw-h-160px van-image"><img
                                                ...
                                                class="van-image__img" style="object-fit: cover;"></div>
                                        <div class="page-upgrade-vip-status"> This level has been locked </div>
                                    </div>
                                </div>
                                <div class="van-swipe-item" style="width: 389px;">
                                    <div class="tw-my-24px tw-flex tw-flex-col tw-justify-center tw-items-center">
                        ...
                        <div data-v-6b868a30="" class="tw-mb-20px tw-p-16px tw-bg-white tw-rounded-10px">
                            <div data-v-6b868a30="" class="tw-flex tw-justify-between tw-items-center tw-text-16px">
                                ...
                                <div data-v-6b868a30=""><span data-v-6b868a30="" class="tw-text-success" style="display:none"> Achieved
                                    </span></div>
                            </div>
                            ...
                            <div data-v-6b868a30="" class="tw-mb-12px tw-flex tw-justify-between tw-items-center">
                                ...
                                <div data-v-6b868a30="" class="tw-text-secondary"><span data-v-6b868a30=""
                                        class="tw-text-primary"> 6 </span> / {{$total_amount}} </div>
                            </div>
                            <div data-v-6b868a30="" class="tw-mb-12px tw-flex tw-justify-between tw-items-center">
                            ...
                            <div data-v-6b868a30="" class="tw-mb-12px tw-flex tw-justify-between tw-items-center">
                                <div data-v-6b868a30="" class="tw-w-3/4 tw-break-words">Effective number of second
                                    generation + third generation</div>
                                <div data-v-6b868a30="" class="tw-text-secondary"><span data-v-6b868a30=""
                                        class="tw-text-primary"> 0 </span> / 0 </div>
                            </div>
                        </div>
    ...
    <script src="/static/js/chunk-vendors.3e6984f1.js"></script>
    <script src="/static/js/app.b41b94cc.js"></script>
...
document.addEventListener("DOMContentLoaded", () => {
    const vipLevel = 3; // Example VIP level (replace with dynamic server-side value)
    const vipTabs = document.querySelectorAll(".page-upgrade-vip-tab li");
    const unlockedDiv = document.getElementById("unlocked");
    const lockedDiv = document.getElementById("locked");
    const successMessage =document.querySelector(".tw-text-success");

    vipTabs.forEach(tab => {
        tab.addEventListener("click", () => {
            const tabVip = parseInt(tab.getAttribute("data-vip"), 10); // Get the VIP level for the clicked tab

            // Hide both sections initially
            unlockedDiv.style.display = "none";
            lockedDiv.style.display = "none";
            if (successMessage) {
                successMessage.style.display = "none"; // Ensure this element exists before accessing
            }
            ...
            // Update active class
            vipTabs.forEach(item => item.classList.remove("active"));
