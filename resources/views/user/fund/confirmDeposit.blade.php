...
<body><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <div id="app">
        <div data-v-6b868a30="" data-v-4bcdfc27="" class="page">
            <div data-v-6b868a30="" class="headers">
                <div data-v-4bcdfc27="" class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center"
    ...
    height: 25px;">
                    ...
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Confirm Deposit</span></div>
...
"></div>
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll" style="height:500px">
                    <div data-v-4bcdfc27="" data-v-6b868a30="" class="page-recharge tw-min-h-full tw-p-16px">
                        <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-mb-10px tw-text-14px">Currency</div>
                        <div data-v-4bcdfc27="" data-v-6b868a30=""
                            class="tw-h-44px tw-px-14px tw-flex tw-justify-between tw-items-center tw-bg-white tw-rounded-10px">
                            <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-flex tw-items-center"><img
                                    data-v-4bcdfc27="" data-v-6b868a30=""
                                    src="https://ts-vertex-all.s3.ap-southeast-1.amazonaws.com/upload/20240325/6ea225b5411abfcabf56b5cc01a8f6f1.jpeg"
                                    alt="" class="tw-w-24px"><span data-v-4bcdfc27="" data-v-6b868a30=""
                                    class="tw-pl-8px"><?php if($paymentMode=="USDT_TRX"){echo "USDT (TRC20)";}elseif($paymentMode=="USDT_BSC"){echo "USDT (BEP20)";}elseif($paymentMode=="LTC"){echo "Litecoin";}elseif($paymentMode=="DOGE"){echo "Dogecoin";}elseif($paymentMode=="BCH"){echo "Bitcoin Cash";}elseif($paymentMode=="ETC"){echo "Ethereum Classic	";}?></span></div><i data-v-4bcdfc27="" data-v-6b868a30=""
                                class="van-icon van-icon-arrow" style="color: rgb(182, 188, 198);">
                                <!----></i>
                        </div>
                        <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-mt-18px tw-mb-10px tw-text-14px"> Selected Amount </div>
                        <div data-v-4bcdfc27="" data-v-6b868a30=""
                            class="tw-h-44px tw-px-14px tw-flex tw-justify-between tw-items-center tw-bg-white tw-rounded-10px">
                            <span data-v-4bcdfc27="" data-v-6b868a30="">{{$invoice_total_sum}}</span><i data-v-4bcdfc27=""
                                data-v-6b868a30="" class="van-icon van-icon-arrow" style="color: rgb(182, 188, 198);">
                                <!----></i></div>
                        <div data-v-4bcdfc27="" data-v-6b868a30=""
                            class="tw-mt-18px tw-mb-10px tw-pt-16px tw-text-14px tw-bg-white tw-rounded-10px">
                            <div data-v-4bcdfc27="" data-v-6b868a30=""
                                ...
                                <div data-v-4bcdfc27="" id="qrcode" value="{{$walletAddress}}" level="H"
                                    background="#fff" foreground="#000" class="custom-qrcode" data-v-6b868a30=""><img
                                       src="{{$qr_code}}" height="240" width="240" style="width: 240px; height: 240px;"></div>
                            </div>
                            <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-mt-16px tw-p-16px">
                                ...
                                <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-flex tw-items-center">
                                    <div data-v-4bcdfc27="" data-v-6b868a30=""
                                        class="tw-flex-1 break tw-break-words tw-text-16px" id="clipboardright">
                                        {{$walletAddress}} </div>
