        ...
        <div data-v-6b868a30="" class="page">
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <div class="tw-w-44px tw-h-full tw-flex tw-items-center"  onClick="window.location.href='{{route('user.grid')}}'"><svg data-v-3f1a7394="" aria-hidden="true"
                            class="svg-icon"
                    ...
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Order History</span></div>
                ...
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-6b868a30="" class="tw-min-h-full tw-p-16px">
                        <div data-v-6b868a30="" class="tw-mb-16px tw-flex tw-items-center tw-gap-24px">
                            <div data-v-6b868a30="" class="tw-flex tw-items-center" onclick=showcur()> Currency： <span data-v-6b868a30=""
                                    class="tw-text-secondary tw-text-12px">all</span><i data-v-6b868a30=""
                                    class="tw-ml-4px van-icon van-icon-arrow-down">
                                    <!----></i></div>
                            <div data-v-6b868a30="" class="tw-flex tw-items-center" onclick=showPopup()> Date： <span
                                    data-v-6b868a30="" class="tw-text-secondary tw-text-12px">Please
                                    select</span><i data-v-6b868a30="" class="tw-ml-4px van-icon van-icon-arrow-down">
                                    </i></div>
                        </div>
...
<?php
 date_default_timezone_set('UTC');
  $cnt = 0; ?>
                        @foreach($deposit_list as $value)
                            <ul class="tw-mb-16px tw-p-16px tw-bg-white tw-rounded-10px">
                                ...
                                <li class="tw-mb-8px tw-flex tw-justify-between tw-items-center">
                                    ...
                                    <div>200.1557 USDT</div>
                                </li>
                                <li class="tw-mb-8px tw-flex tw-justify-between tw-items-center">
                                    <div class="tw-text-secondary">Cryptocurrency</div>
                                    <div>AMZN</div>
                                </li>
    ...
    <div class="van-popup van-popup--round van-popup--bottom" id="datePickerTrigger" style="z-index: 2002; display:none">
        <div class="tw-p-16px">
            <div class="tw-text-16px">Time filter</div>
            <div class="tw-my-16px tw-flex tw-justify-between tw-items-center tw-gap-16px">
                <div
                    class="tw-flex-1 tw-px-12px tw-py-10px tw-border tw-border-secondary tw-border-opacity-30 tw-rounded-10px">
                    2020/01/01 </div>
                <div class="tw-h-2px tw-w-16px tw-bg-secondary tw-bg-opacity-30"></div>
                <div
                    class="tw-flex-1 tw-px-12px tw-py-10px tw-border tw-border-secondary tw-border-opacity-30 tw-rounded-10px">
                    2024/11/28 </div>
            </div>
            <div class="tw-mb-16px van-picker van-datetime-picker">
                <!---->
                    ...
                    <div class="van-picker-column">
                        <ul class="van-picker-column__wrapper"
                            ...
                            <li role="button" tabindex="0"
                                class="van-picker-column__item van-picker-column__item--selected" style="height: 44px;">
                ...
                <!---->
            </div><button class="van-button van-button--primary van-button--normal van-button--block" onclick=hidePopup()>
    ...
    <div data-v-91b14df4="" class="van-popup van-popup--round van-popup--bottom" id="currencypicker"
        ...
        <div data-v-91b14df4="" class="popup_box">
            <div data-v-91b14df4="" class="scroll">
                <div data-v-91b14df4="" class="ul">
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item active"> all </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> ATOM </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> BCH </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> BNB </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> BTC </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> DOGE </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> DOT </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> EOS </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> ETC </div>
                    </div>
                    <div data-v-91b14df4="">
                        <div data-v-91b14df4="" class="item"> ETH </div>
                    </div>
                </div>
            </div>
            <div data-v-91b14df4="" onclick=hidecur() class="esc">Cancel</div>
        </div>
    </div>
    <!---->
    <script>
    // Get the trigger and popup elements
    ...
    // function showPopup() {
    //     datePickerTrigger.style.display = 'block'; 
    // }
    // function hidePopup() {
    //     datePickerTrigger.style.display = 'none';
    // }    
