...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-ee444bf8.1b9d7d9a.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-75fb7d77.4347cc4f.css">
    <script charset="utf-8" src="/static/js/chunk-75fb7d77.6adc70a1.js"></script>
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-2ec80ff3.d777b076.css">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-686843b8.ce066fac.css">
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
</head>
...
<body>
        ...
        <div data-v-6b868a30="" class="page page-mine">
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <div class="tw-w-44px tw-h-full tw-flex tw-items-center"  onclick="location.href='{{route('user.dashboard')}}'">
                    <img src="/img/left.png" onClick="window.location.href='{{route('user.dashboard')}}'" style="
    height: 25px;">
                        <!---->
                    </div>
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Mine</span></div>
                    <div class="tw-h-full tw-min-w-44px tw-flex tw-justify-end tw-items-center tw-gap-12px">
                        <!---->
                        <div onClick="window.location.href='{{ route('user.meassage') }}'"
                        ><img src="/img/bell.png" style="  height: 25px;"></div>
                        <!---->
                        <!---->
                    </div>
                </div>
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-6b868a30="" class="tw-min-h-full tw-p-16px">
                        <div data-v-6b868a30="" class="page-mine-header tw-mb-16px">
                            <div data-v-6b868a30="" class="tw-mb-16px tw-flex tw-justify-between tw-items-center">
                                <div data-v-6b868a30="" class="tw-flex tw-items-center">
                                    <div data-v-6b868a30=""
                                        class="tw-w-60px tw-h-60px tw-rounded-full tw-overflow-hidden"><img
                                            data-v-6b868a30=""
                                    ...
                                    <div data-v-6b868a30="" class="tw-ml-12px">
                                        ...
                                        <div data-v-6b868a30="" class="tw-text-12px tw-flex tw-items-center"><span
                                            ...
                                            </span><span data-v-6b868a30="" class="tw-px-8px">{{Auth::user()->username}}</span><span
                                        ...
                                        <div data-v-6b868a30="" class="tw-text-12px"><span data-v-6b868a30=""
                                                ...
                                                class="tw-pl-4px">3171432</span></div>
                                    </div>
                                </div><i data-v-6b868a30="" class="tw-text-20px van-icon van-icon-arrow" onclick="location.href='{{route('user.showinfo')}}'">
                                    <!----></i>
                            </div>
                            <div data-v-6b868a30=""
                                ...
                                <div data-v-6b868a30="" class="tw-flex tw-items-center">
                                    <div data-v-6b868a30=""
                                        ...
                                        class="tw-pl-8px tw-text-16px tw-text-white" style="color:#020503"> SK 0 </span>
                                </div>
                                <div data-v-6b868a30="" class="level-btn"><button data-v-6b868a30="" onClick="location.href='{{route('user.strategy')}}'"
                        ...
                        <div data-v-6b868a30="" class="tw-mb-16px tw-p-16px tw-bg-white tw-rounded-10px">
                            <ul data-v-6b868a30="" class="tw-flex tw-justify-between">
                                <li data-v-6b868a30="" class="tw-flex-1 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.fund')}}'">
                                    <div data-v-6b868a30="" class="tw-flex tw-flex-col tw-items-center">                                        
                                            <img src="{{asset('')}}img/invest.png" style="width: 1.024rem; height: 0.9412rem;">
                                        <div data-v-6b868a30="" class="tw-text-12px tw-text-center tw-break-words">
                                            Deposit </div>
                                    </div>
                                </li>
                                <li data-v-6b868a30="" class="tw-flex-1 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.helpcenter')}}'">
                                    <div data-v-6b868a30="" class="tw-flex tw-flex-col tw-items-center">
                                    <img src="{{asset('')}}img/withdraw.png" style="width: 1.024rem; height: 0.9412rem;">
                                        <div data-v-6b868a30="" class="tw-text-12px tw-text-center tw-break-words">
                                            Order History </div>
                                    </div>
                                </li>
                                <li data-v-6b868a30="" class="tw-flex-1 tw-flex tw-flex-col tw-items-center"  onclick="location.href='{{route('user.helpcenter')}}'">
                                    <span
                                        ...
                                        <img src="{{asset('')}}img/platform.png" style="width: 1.024rem; height: 0.9412rem;">
                                            <div class="tw-text-12px tw-text-center tw-break-words"> Social Media </div>
                                        </div>
                                    </span></li>
                                <li data-v-6b868a30="" class="tw-flex-1 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.team-record')}}'">
                                    <div data-v-6b868a30="" class="tw-flex tw-flex-col tw-items-center">
                                    <img src="{{asset('')}}img/team1.png" style="width: 1.024rem; height: 0.9412rem;">
                        ...
                        <div data-v-6b868a30="" class="tw-mb-16px tw-px-16px tw-pt-16px tw-bg-white tw-rounded-10px">
                            <div data-v-6b868a30="" class="tw-mb-12px tw-text-16px">Menu</div>
                            <ul data-v-6b868a30="" class="tw-flex tw-flex-wrap">
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/3 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.terms')}}'">
                                <img src="{{asset('')}}img/terms.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"
                                        style="word-break: break-all;"> Terms of Use </div>
                                </li>
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/3 tw-flex tw-flex-col tw-items-center"  onclick="location.href='{{route('user.about')}}'">
                                <img src="{{asset('')}}img/identy.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"
                                        style="word-break: break-all;"> Verify </div>
                                </li>
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/3 tw-flex tw-flex-col tw-items-center"  onclick="location.href='{{route('user.about')}}'">
                                <img src="{{asset('')}}img/terms.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"
                                        style="word-break: break-all;">Authenticator</div>
                                </li>
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/3 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.ChangePass')}}'">
                                <img src="{{asset('')}}img/password.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"
                                        style="word-break: break-all;"> Login Password </div>
                                </li>
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/3 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.tpassword')}}'">
                                <img src="{{asset('')}}img/terms.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"
                                        style="word-break: break-all;">Change Password</div>
                                </li>
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/3 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.ChangeMail')}}'">
                                <img src="{{asset('')}}img/terms.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"
                                        style="word-break: break-all;"> Change Mail </div>
                                </li>
                            </ul>
                        </div>
                        <div data-v-6b868a30="" class="tw-mb-16px tw-px-16px tw-pt-16px tw-bg-white tw-rounded-10px">
                            ...
                            <ul data-v-6b868a30="" class="tw-flex tw-flex-wrap">
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/4 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.feedback')}}'">
                                <img src="{{asset('')}}img/feedback.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"> Feedback
                                    </div>
                                </li>
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/4 tw-flex tw-flex-col tw-items-center"  onclick="location.href='{{route('user.helpcenter')}}'">
                                <img src="{{asset('')}}img/help.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"> Help
                                        Center </div>
                                </li>
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/4 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.lang')}}'">
                                <img src="{{asset('')}}img/changelang.png" style=" height: 30px;">
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"> Switch
                                        Language </div>
                                </li>
                                <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/4 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.lang')}}'">
                                <img src="{{asset('')}}img/custmer.png" style=" height: 30px;">
                                ...
                                <!-- <li data-v-6b868a30="" class="tw-mb-16px tw-w-1/4 tw-flex tw-flex-col tw-items-center" onclick="location.href='{{route('user.helpcenter')}}'">
                                    <svg data-v-3f1a7394="" aria-hidden="true" class="tw-mb-4px svg-icon" alt=""
                                        ...
                                        <use data-v-3f1a7394="" xlink:href="#svg-icon-download"></use>
                                    </svg>
                                    <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"> APP
                                        download </div>
                                </li> -->
                            </ul>
                        </div>
                        ...
                        <button data-v-6b868a30="" href="{{ route('logout') }}" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();" style="background-color: #b5cff8;"
                        ...
                        <!-- <button data-v-6b868a30="" style="background-color: #b5cff8;"
    ...
    <div class="van-toast van-toast--middle van-toast--text" style="z-index: 2003; display: none;">
