...
<head>
    ...
    <script charset="utf-8" src="/static/js/chunk-ea0143b0.5da99a28.js"></script>
    <link rel="stylesheet" type="text/css" href="{{asset('')}}css/chunk-80de0c60.cf3f8720.css">
    <script charset="utf-8" src="/static/js/chunk-80de0c60.db818780.js"></script>
...
<body><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <div id="app">
        <div data-v-6b868a30="" data-v-220ee269="" class="page">
            <div data-v-6b868a30="" class="headers">
                <div data-v-220ee269="" class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center"
                    data-v-6b868a30="" style="background-color: transparent;">
                    <div class="tw-w-44px tw-h-full tw-flex tw-items-center" onClick="window.location.href='{{route('user.team')}}'"><svg data-v-3f1a7394="" aria-hidden="true"
                            class="svg-icon"
                            style="color: #fff; width: 0.4706rem; height: 0.4706rem; font-size: 0.4706rem;">
                    ...
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: #fff;"><span>Team List</span></div>
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-220ee269="" data-v-6b868a30="" class="page-team-record tw-min-h-full tw-p-16px">
                        <ul data-v-220ee269="" data-v-6b868a30=""
                            class="tab-list tw-mb-16px tw-h-40px tw-p-4px tw-flex tw-justify-between tw-items-stretch tw-bg-white tw-rounded-10px" style="height:20px">
                            <li data-v-220ee269="" data-v-6b868a30=""
                                class="tab tw-flex-1 tw-h-32px tw-flex tw-justify-center tw-items-center tw-text-secondary tw-rounded-8px tw-text-primary tw-bg-primary tw-bg-opacity-10">
                                First Gen </li>
                            <li data-v-220ee269="" data-v-6b868a30=""
                                class="tab tw-flex-1 tw-h-32px tw-flex tw-justify-center tw-items-center tw-text-secondary tw-rounded-8px">
                                Second Gen </li>
                            <li data-v-220ee269="" data-v-6b868a30=""
                                class="tab tw-flex-1 tw-h-32px tw-flex tw-justify-center tw-items-center tw-text-secondary tw-rounded-8px">
                                Third Gen </li>
                        </ul>
                        <div data-v-220ee269="" class="van-pull-refresh" data-v-6b868a30="">
                            <div class="van-pull-refresh__track" style="transition-duration: 0ms;">
                                <div class="van-pull-refresh__head" style="height: 50px;"></div>
                                <div data-v-220ee269="" role="feed" class="van-list">
                                <?php if(is_array($direct_team) || is_object($direct_team)){ ?>

                                  <?php $cnt = $direct_team->perPage() * ($direct_team->currentPage() - 1); ?>
                                    @foreach ($direct_team as $value)
                                    <div data-v-220ee269=""
                                        class="tw-relative tw-mb-12px tw-px-16px tw-py-12px tw-bg-white tw-rounded-10px">
                                        <div data-v-220ee269=""
                                            class="tw-mb-16px tw-pb-14px tw-h-74px tw-flex tw-items-center van-hairline--bottom">
                                            <div data-v-220ee269="" class="tw-flex-1 tw-flex tw-items-center"><img
                                                    data-v-220ee269=""
                                                ...
                                                <ul data-v-220ee269="">
                                                    <li data-v-220ee269="">ID：{{$value->username}}</li>
                                                    <li data-v-220ee269="" class="tw-text-secondary tw-text-12px">
                                                        ({{$value->phone}}) </li>
                                                    <li data-v-220ee269="" class="tw-text-secondary tw-text-12px">
                                        ...
                                        <ul data-v-220ee269="" class="tw-flex tw-justify-between tw-items-center">
                                            <li data-v-220ee269="" class="tw-flex-1 tw-text-center">
                                                <div data-v-220ee269="" class="tw-mb-4px"> 0.1252 USDT </div>
                                                <div data-v-220ee269="" class="tw-text-secondary tw-text-12px"> Total
                                                    Income </div>
                                            </li>
                                            <li data-v-220ee269="" class="tw-flex-1 tw-text-center">
                                                <div data-v-220ee269="" class="tw-mb-4px"> {{ ($value->investment->sum('amount'))?$value->investment->sum('amount'):0 }} USDT </div>
                                                <div data-v-220ee269="" class="tw-text-secondary tw-text-12px"> Total
                                                    Deposit </div>
                                            </li>
                                            <li data-v-220ee269="" class="tw-flex-1 tw-text-center">
                                                <div data-v-220ee269="" class="tw-mb-4px"> 0 USDT </div>
                                                <div data-v-220ee269="" class="tw-text-secondary tw-text-12px"> Total
                                                    Withdrawal </div>
                                            </li>
                                        </ul>
    ...
    <script src="/static/js/chunk-vendors.1fd96954.js"></script>
    <script src="/static/js/app.25f2922a.js"></script>
</body>
