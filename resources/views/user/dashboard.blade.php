...
.swiper-horizontal{
    ...
    <link href="{{asset('')}}css/chunk-41625792.a5e4171e.css" rel="stylesheet">
...
<body>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110 24" fill="none" id="svg-icon-logo-long">
            ...
            <path d="M14.4528 1.3239L10.4248 5.46795L4.20009 4.14155L8.82808 0L14.4528 1.3239Z" fill="#125BC5"></path>
            <path d="M10.4248 5.46788L12.3313 11.9924L8.36831 16.3588L4.20009 4.14148L10.4248 5.46788Z" fill="#1772F8">
            </path>
        ...
        <div data-v-6b868a30="" class="page">
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <img src="/img/menu.png" style="height: 25px;" onClick="window.location.href='{{route('user.Mine')}}'">
                    </div>
                    ...
                    <div class="tw-h-full tw-min-w-44px tw-flex tw-justify-end tw-items-center tw-gap-12px"><svg
                        ...
                        <div><img src="/img/bell.png" style="
    height: 25px;
"></div>
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll">                    
                    <div data-v-6b868a30="" class="tw-p-16px">
                        <!-- <div class="tw-bg-white tw-rounded-bl-10px tw-rounded-br-10px" data-v-6b868a30="">
                            <div class="van-swipe">
                                <div class="van-swipe__track"
                                    style="transition-duration: 500ms; transform: translateX(-1167px); width: 1556px;">
                                    <div class="van-swipe-item" style="width: 389px;">
                                        <div class="tw-w-full tw-h-150px tw-rounded-10px tw-bg-cover tw-bg-no-repeat"
                                    ...
                                    <div class="van-swipe-item" style="width: 389px;">
                                        <div class="tw-w-full tw-h-150px tw-rounded-10px tw-bg-cover tw-bg-no-repeat"
                                            style="background-image: url(&quot;http://seokore-all.s3.ap-southeast-1.amazonaws.com/upload/20240829/6d95043d2a75d23b5ab176800fbced66.png&quot;);">
                                        </div>
                                    </div>
                                    <div class="van-swipe-item" style="width: 389px;">
                                        <div class="tw-w-full tw-h-150px tw-rounded-10px tw-bg-cover tw-bg-no-repeat"
                            ...
                            <div role="alert" class="van-notice-bar" style="color: rgb(24, 25, 28); background: none;">
                                ...
                                <div role="marquee" class="van-notice-bar__wrap">
                                    <div class="van-notice-bar__content"
                                        style="transition-duration: 104.208s; transform: translateX(-5927.17px);">
                                        3165276Open Strategy Welcome 3171432 to join Seokore 3171392Recharge50
                                        3170710Open Strategy 3165357Open Strategy 3171307Open Strategy 3170861Open
                                        Strategy 3164740Open Strategy 3171162Open Strategy 3166829Open Strategy
                                        3170683Open Strategy 3170554Open Strategy 3167706Open Strategy 3167453Open
                                        Strategy 3164993Open Strategy 3168258Open Strategy 3170404Open Strategy
                                        3169262Open Strategy 3164109Open Strategy 3170885Open Strategy 3165984Open
                                        Strategy 3169977Open Strategy 3167737Open Strategy 3171423Open Strategy Welcome
                                        3171423 to join Seokore 3165945Open Strategy 3170737Open Strategy 3171414Open
                                        Strategy Welcome 3171414 to join Seokore 3171406Open Strategy Welcome 3171406 to
                                        join Seokore 3171392Open Strategy Welcome 3171398 to join Seokore </div>
                                </div>
                            </div>
                        </div> -->
                        <!-- <ul class="page-home-card tw-mt-16px tw-flex tw-justify-between tw-items-center tw-gap-4px"
                            data-v-6b868a30="">
                            <li
                                class="invite tw-flex-1 tw-pt-20px tw-px-12px tw-text-16px tw-text-white tw-font-bold tw-break-words" onClick="window.location.href='{{route('user.invite')}}'">
                                Invite friends </li>
                            <li
                            ...
                            <li
                                ...
                                Levels <div class="tw-mt-12px tw-ml-4px tw-w-80px van-image"><img
                                        src="{{asset('')}}img/2990dbe8b66676d6d1602405620a8d2b.png"
                                        class="van-image__img"></div>
                            </li>
                        </ul> -->
                        <div data-v-6b868a30="" class="tw-mt-16px tw-p-16px tw-bg-white tw-rounded-10px" style="height:290px; background-color:#b5cff8">
                            <div data-v-6b868a30="" class="tw-mb-12px tw-flex tw-justify-between tw-items-center" style="margin-bottom:0px">
                                <div data-v-6b868a30="" class="tw-text-16px" style="color:#020503">NEWS</div>
                                <a href="/news/?typeId=1"></a>
                                    <span class="tw-text-secondary" data-v-6b868a30="" style="color:#020503"> More </span>
                            </div>
            ...
            @foreach ($articles as $article)
                <div class="swiper-slide article-item"
                    ...
                    <div class="tw-w-full">
                        ...
                        <div class="tw-my-4px tw-break-words van-multi-ellipsis--l2" style="color:#020503">
                            {{ $article['source']['name'] }}
                        </div>
                        <div class="tw-text-secondary tw-text-12px" style="color:#020503">
                            {{ $article['title'] }}
                        </div>
                    </div>
                </div>
...
@endif
                        ...
                        <div data-v-6b868a30="" class="tw-p-16px tw-bg-white tw-rounded-bl-16px tw-rounded-br-16px" style="margin-top:20px; border-radius: .42667rem;">
                        <ul data-v-6b868a30="" class="tw-flex tw-justify-between">
                            <li data-v-6b868a30="" class="tw-h-full tw-flex-1 tw-flex tw-flex-col tw-items-center"  onClick="window.location.href='{{ route('user.fund') }}'"><img
                                    data-v-6b868a30=""
                                    src="{{asset('')}}img/invest.png"
                                    alt="" class="tw-mb-6px tw-w-52px tw-h-40px" style="width:1.08667rem; height:1.02667rem">
                                <div data-v-6b868a30="" class="tw-text-12px tw-break-words tw-text-center"> Deposit now
                                </div>
                            </li>
                            <li data-v-6b868a30="" class="tw-h-full tw-flex-1 tw-flex tw-flex-col tw-items-center" onClick="window.location.href='{{ route('user.Withdraw') }}'"><img
                                    data-v-6b868a30=""
                                    src="{{asset('')}}img/withdraw.png"
                                    alt="" class="tw-mb-6px tw-w-52px tw-h-40px" style="width:1.08667rem; height:1.02667rem">
                            ...
                            <li data-v-6b868a30="" class="tw-h-full tw-flex-1 tw-flex tw-flex-col tw-items-center"><img
                                    data-v-6b868a30=""
                                    src="{{asset('')}}img/platform.png"onClick="window.location.href='{{ route('user.showinfo') }}'"
                                    alt="" class="tw-mb-6px tw-w-52px tw-h-40px" style="width:1.08667rem; height:1.02667rem">
                            ...
                            <li data-v-6b868a30="" class="tw-h-full tw-flex-1 tw-flex tw-flex-col tw-items-center"><img
                                    data-v-6b868a30=""
                                    src="{{asset('')}}img/help1.png" onClick="window.location.href='{{ route('user.showinfo') }}'"
                                    alt="" class="tw-mb-6px tw-w-52px tw-h-40px" style="width:1.08667rem; height:1.02667rem">
                        ...
                        <ul class="page-home-card tw-mt-16px tw-flex tw-justify-between tw-items-center tw-gap-4px"
                            ...
                            <li
                                class="level tw-flex-1 tw-pt-20px tw-px-12px tw-text-16px tw-text-white tw-font-bold tw-break-words">
                                Levels <div class="tw-mt-12px tw-ml-4px tw-w-80px van-image" onClick="location.href='{{route('user.strategy')}}'"><img
                                        src="{{asset('')}}img/2990dbe8b66676d6d1602405620a8d2b.png"
                                        class="van-image__img" style="height:90px"></div>
                            </li>
                        </ul>
                        <ul data-v-6b868a30="" class="page-home-market-tab">
                            <li data-v-6b868a30="" class="tw-flex-1 tw-text-center active" id="text1" onclick=showRates()>Currency Prices </li>
                            <li data-v-6b868a30="" class="tw-flex-1 tw-text-center" id="text2" onclick=showNews()> Currency News </li>
                        </ul>
                        <div data-v-6b868a30=""
                            class="page-home-market-content tw-pt-12px tw-px-14px tw-bg-white tw-rounded-bl-10px tw-rounded-br-10px" id="padd" style="max-height: 500px; padding-top:.32rem;
                                   overflow: scroll; border-radius:10px">                           
                            <!-- ebrf -->
                             <div data-v-40a6c17a="" class="market_card"  id="showrates" style="display:block">
                                 <div data-v-40a6c17a="" class="market_box">
                                     <div data-v-40a6c17a="" class="market_list">                                         
                                         <div data-v-40a6c17a="" class="market-list" style="background:#313131">
                                             ...
                                             <div data-v-40a6c17a="" class="quotes-list">
                                                 <div data-v-40a6c17a="" class="list-coin"><img data-v-40a6c17a=""
                                                         src="http://seokore-all.s3.ap-southeast-1.amazonaws.com/upload/20240821/806e976b7114be87da953604cdd9bf14.png"
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="coin-name">
                                                         <div data-v-40a6c17a="" style="line-height: 0.28rem;color:#fff">BNB</div>
                                                         <p data-v-40a6c17a="">USDT</p>
                                                     </div>
                                                 </div>
                                                 <div data-v-40a6c17a="" class="list-price" style="color:#fff" id="bnb-rate">$654.19</div>
                                                 <div data-v-40a6c17a="" class="list-down" style="color:#fff"><img data-v-40a6c17a=""
                                                         ...
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="up" id="bnb-percentage">+0.05%</div>
                                                 </div>
                                             </div>
                                             <div data-v-40a6c17a="" class="quotes-list">
                                                 <div data-v-40a6c17a="" class="list-coin"><img data-v-40a6c17a=""
                                                         ...
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="coin-name">
                                                         <div data-v-40a6c17a="" style="line-height: 0.28rem;color:#fff">DOGE
                                                         </div>
                                                         <p data-v-40a6c17a="">USDT</p>
                                                     </div>
                                                 </div>
                                                 <div data-v-40a6c17a="" class="list-price" style="color:#fff" id="doge-rate">$0.40667</div>
                                                 <div data-v-40a6c17a="" class="list-down" style="color:#fff"><img data-v-40a6c17a=""
                                                         src="data:image/png;base64,"
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="up" id="doge-percentage">+1.26%</div>
                                                 </div>
                                             </div>
                                             <div data-v-40a6c17a="" class="quotes-list">
                                                 <div data-v-40a6c17a="" class="list-coin"><img data-v-40a6c17a=""
                                                         ...
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="coin-name">
                                                         <div data-v-40a6c17a="" style="line-height: 0.28rem;color:#fff">LTC</div>
                                                         <p data-v-40a6c17a="">USDT</p>
                                                     </div>
                                                 </div>
                                                 <div data-v-40a6c17a="" class="list-price" style="color:#fff"id="ltc-rate">$96.57</div>
                                                 <div data-v-40a6c17a="" class="list-down" style="color:#fff"><img data-v-40a6c17a=""
                                                         src="data:image/png;base64,"
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="up" id="ltc-percentage">+1.07%</div>
                                                 </div>
                                             </div>
                                             <div data-v-40a6c17a="" class="quotes-list">
                                                 <div data-v-40a6c17a="" class="list-coin"><img data-v-40a6c17a=""
                                                         src="http://seokore-all.s3.ap-southeast-1.amazonaws.com/upload/20240821/1d2cf70f6439db3c9efbd0a60659e287.png"
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="coin-name">
                                                         <div data-v-40a6c17a="" style="line-height: 0.28rem;color:#fff">BTC</div>
                                                         <p data-v-40a6c17a="">USDT</p>
                                                     </div>
                                                 </div>
                                                 <div data-v-40a6c17a="" class="list-price" style="color:#fff" id="btc-rate">$96446.86</div>
                                                 <div data-v-40a6c17a="" class="list-down" style="color:#fff"><img data-v-40a6c17a=""
                                                         src="data:image/png;base64,"
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="up" id="btc-percentage">+0.83%</div>
                                                 </div>
                                             </div>
                                             <div data-v-40a6c17a="" class="quotes-list">
                                                 <div data-v-40a6c17a="" class="list-coin"><img data-v-40a6c17a=""
                                                         src="http://seokore-all.s3.ap-southeast-1.amazonaws.com/upload/20240821/1ffebe6d5c13d310ec5f5dac980cd8ab.png"
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="coin-name">
                                                         <div data-v-40a6c17a="" style="line-height: 0.28rem;color:#fff">ETH</div>
                                                         <p data-v-40a6c17a="">USDT</p>
                                                     </div>
                                                 </div>
                                                 <div data-v-40a6c17a="" class="list-price" style="color:#fff"id="eth-rate">$3585.3</div>
                                                 <div data-v-40a6c17a="" class="list-down" style="color:#fff"><img data-v-40a6c17a=""
                                                         src="data:image/png;base64,"
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="up" id="eth-percentage">+0.18%</div>
                                                 </div>
                                             </div>
                                             <div data-v-40a6c17a="" class="quotes-list">
                                                 <div data-v-40a6c17a="" class="list-coin"><img data-v-40a6c17a=""
                                                         ...
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="coin-name">
                                                         <div data-v-40a6c17a="" style="line-height: 0.28rem;color:#fff">DOT</div>
                                                         <p data-v-40a6c17a="">USDT</p>
                                                     </div>
                                                 </div>
                                                 <div data-v-40a6c17a="" class="list-price" style="color:#fff">$8.482</div>
                                                 <div data-v-40a6c17a="" class="list-down" style="color:#fff"><img data-v-40a6c17a=""
                                                         ...
                                                         alt="">
                                                     <div data-v-40a6c17a="" class="">-1.54%</div>
                                                 </div>
                                             </div>
                                             <!---->
                                         </div>
                             ...
                             <!-- news -->
                           <div data-v-6b868a30="" class="market-list" id="shownews" style="display:none">
                                <div class="tw-h-66px tw-flex tw-justify-between tw-items-center van-hairline--bottom"
                                    data-v-6b868a30="">
                        ...
                        <div data-v-6b868a30="" class="tw-mt-24px">
                            ...
                            <ul data-v-6b868a30="" class="tw-grid tw-grid-cols-3 tw-gap-16px">
                                <li data-v-6b868a30=""
                                    ...
                                    <img data-v-6b868a30=""
                                        src="{{asset('')}}img/20f7ade14d37d182eef08551be181698.png"
                                        class="tw-w-full"></li>
                                <li data-v-6b868a30=""
                                    class="tw-px-16px tw-h-44px tw-bg-white tw-rounded-full tw-flex tw-justify-center tw-items-center">
                                    <img data-v-6b868a30=""
                                        src="{{asset('')}}img/5c787d228a90e84a5a1de7e0d6379bcf.png"
                                        class="tw-w-full"></li>
                                <li data-v-6b868a30=""
                                    class="tw-px-16px tw-h-44px tw-bg-white tw-rounded-full tw-flex tw-justify-center tw-items-center">
                                    <img data-v-6b868a30=""
                                        src="{{asset('')}}img/a839f92e86dea1769794d1178004e5d3.png"
                                        class="tw-w-full"></li>
                                <li data-v-6b868a30=""
                                    class="tw-px-16px tw-h-44px tw-bg-white tw-rounded-full tw-flex tw-justify-center tw-items-center">
                                    <img data-v-6b868a30=""
                                        src="{{asset('')}}img/3f3f6bb14f3505efc9afcfcbb9ddbbf0.png"
                                        class="tw-w-full"></li>
                                <li data-v-6b868a30=""
                                    class="tw-px-16px tw-h-44px tw-bg-white tw-rounded-full tw-flex tw-justify-center tw-items-center">
                                    <img data-v-6b868a30=""
                                        src="{{asset('')}}img/d8eb157fb147fa29f0fefd34b1bddd24.png"
                                        class="tw-w-full"></li>
                                <li data-v-6b868a30=""
                                    class="tw-px-16px tw-h-44px tw-bg-white tw-rounded-full tw-flex tw-justify-center tw-items-center">
                                    <img data-v-6b868a30=""
                                        src="{{asset('')}}img/f5352209ec88fe461a0a3ada0a83a1f0.png"
                                        class="tw-w-full"></li>
                            </ul>
                        </div>
    ...
    document.querySelectorAll('.article-item').forEach(item => {
        item.addEventListener('click', function () {
            // Retrieve the article data from the data attribute
            const articleData = JSON.parse(this.getAttribute('data-article'));

            // Store the article data in sessionStorage
            sessionStorage.setItem('selectedArticle', JSON.stringify(articleData));
...
var showrates =document.getElementById('showrates');
var padding =document.getElementById('padd');
var active = document.getElementById('text1');
var nactive =document.getElementById('text2');

function showRates(){
  showrates.style.display="block";
  shownews.style.display="none";
  padding.style.paddingTop = ".32rem";
  active.classList.add("active");
  nactive.classList.remove("active");
}
function showNews(){
    shownews.style.display="block";
    showrates.style.display="none";
    padding.style.paddingTop = "5.32rem";
...
<script>
    $(document).ready(function(){
        ...
        function fetchBtcRate() {           
                ...
                $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#btc-rate').text("$"+ parseFloat(btcRate).toFixed(4));
        ...
        fetchBtcRate();
        setInterval(fetchBtcRate, 2000); // 5000 milliseconds = 5 seconds
        ...
        // Call the function initially and then every 5 seconds
        fetchDogeRate();
        setInterval(fetchDogeRate, 2000); // 5000 milliseconds = 5 seconds

        //  my function start here 
        function fetchBnbRate() {
            var exchange = $('#exchange').val();
            ...
            if (exchange=="BINANCE")
             ...
             {
                var apiUrl = 'https://api.kucoin.com/api/v1/market/stats?symbol=BNB-USDT';
                $.ajax({
                url: apiUrl,
                method: 'GET',
                ...
                success: function(response) {
                    ...
                    // Update the HTML element with the live BTC rate
                    $('#bnb-rate').text("$"+ parseFloat(btcRate).toFixed(4));
                    $('#bnb-percentage').text(parseFloat(percentageChange).toFixed(2)+"%").css('background',(percentageChange>0)?'#00bc81':'red');
             ...
             else
             {
                ...
                var apiUrl = 'https://api.huobi.pro/market/detail/merged?symbol=bnbusdt';
                $.ajax({
                url: apiUrl,
                method: 'GET',
        ...
        // Call the function initially and then every 5 seconds
        fetchBnbRate();
        setInterval(fetchBnbRate, 2000);; // 5000 milliseconds = 5 seconds
        ...
        function fetchLtcRate() {          
                ...
                var apiUrl = 'https://api.binance.com/api/v3/ticker/24hr?symbol=LTCUSDT';             
                // Function to fetch BTC rate
                $.ajax({
                        url: apiUrl,
                        method: 'GET',
                        ...
                        success: function(response) {
                            ...
                            // Update the HTML element with the live BTC rate
                            $('#ltc-rate').text("$"+ parseFloat(btcRate).toFixed(4));
                            $('#ltc-percentage').text(parseFloat(percentageChange).toFixed(2)+"%").css('background',(percentageChange>0)?'#00bc81':'red');
